...
<DOCTYPE html>
  ...
  <head>
    ...
    <title>Court Task Management</title>
...
<div id="ads" class="container">
     <legend> <h3><b>Add Task</h3></legend>
      <form action="create_task.php" method="POST">
        <div class="form-row">
          <div class="form-group col-md-6">
            <label for="input">Select Case</label>
            <select name="CASE_NO" class="form-control" required>
...
if($num2> 0){
 ...
 ?>
       ...
       <div class="form-group col-md-12">
          ...
          <input type="text" class="form-control" id="input" placeholder="WRITE YOUR TASK" name="DETAIL">
        </div>
        <div class="form-group col-md-4">
          <label for="input">Schdule Your Task</label>
          <input type="date" class="form-control" id="input" placeholder="" name="DATE">
        </div>
        <div class="form-group col-md-4">
    ...
    <?php
$sql3 = "SELECT * FROM `task` WHERE `EMAIL`='$EMAIL' ";
...
<tr style="border: 3px solid  #1273;">
  ...
  <td style="border: 1px   #1273;"><b> Schedule of Task</b> </td>
...
<tr style="color:cornflowerblue;">
  ...
  <td style="border: 1px  #1273;font-size:20px;"><b><?php echo $row3["CASE_NO"]; ?></b></td>
  ...
  <td style="border: 1px  #1273;font-size:20px;"><b><?php echo $row3["DATE"]; ?></b></td>
  <td style="border: 1px  #1273;font-size:20px;"><b> <a href="delete_task.php?ID= <?php echo $row3['CASE_NO'] ;?>"><p>Click Here</p></a></b></td>
</tr>
<?php
$i++;
}
